...
#define RACE_RAM_WINDOW_LOG_STRIDE (4)
...
#define RACE_TASK4_EXIT_TURN_PREDICT_MS     (65)
...
#define RACE_POINT_ADVANCE_COUNT    (500)
...
#define RACE_TASK4_FIRST_AC_FORCE_TURN_COUNT (7900)
