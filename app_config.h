...
#define TASK3_ARC_ENTRY_EDGE_ERROR    (1800)
#define TASK3_ARC_ENTRY_EDGE_RECOVER_TURN (120)
...
/* UART 10/11：纯红外跑图测试，并用 JY62 记录航向角。 */
#define TASK11_POINT_ALARM_MS         (80)
#define TASK11_POINT_SETTLE_MS        (120)
#define TASK11_TARGET_LAPS            (20)
#define TASK11_TOTAL_MAX_RUN_MS       (240000)
#define TASK11_LINE_REPORT_PERIOD_MS  (1000)
#define TASK11_ARC_REPORT_PERIOD_MS   (500)
#define TASK11_STRAIGHT_B_BASE_PWM    (STRAIGHT_B_BASE_PWM)
#define TASK11_STRAIGHT_A_BASE_PWM    (STRAIGHT_A_BASE_PWM)
#define TASK11_ARC_B_BASE_PWM         (TASK3_ARC_B_BASE_PWM)
#define TASK11_ARC_A_BASE_PWM         (TASK3_ARC_A_BASE_PWM)
#define TASK11_STRAIGHT_MAX_PWM       (STRAIGHT_MAX_PWM)
#define TASK11_ARC_MAX_PWM            (TASK3_ARC_MAX_PWM)
#define TASK11_LINE_BASE_PWM          (TASK11_ARC_B_BASE_PWM)
#define TASK11_LINE_MIN_PWM           (0)
#define TASK11_LINE_MAX_PWM           (760)
#define TASK11_LINE_TURN_DIVISOR      (9)
#define TASK11_LINE_KD_DIVISOR        (12)
#define TASK11_LINE_DERIV_LIMIT       (500)
#define TASK11_LINE_TURN_LIMIT        (260)
#define TASK11_STRAIGHT_KP_DIVISOR    (14)
#define TASK11_STRAIGHT_KD_DIVISOR    (18)
#define TASK11_STRAIGHT_DERIV_LIMIT   (360)
#define TASK11_STRAIGHT_TURN_LIMIT    (170)
#define TASK11_ARC_KP_DIVISOR         (13)
#define TASK11_ARC_KD_DIVISOR         (14)
#define TASK11_ARC_DERIV_LIMIT        (500)
#define TASK11_ARC_IR_TURN_LIMIT      (170)
#define TASK11_ARC_TOTAL_TURN_LIMIT   (300)
#define TASK11_LINE_ERROR_FILTER_DIVISOR (2)
#define TASK11_LINE_LOST_BASE_DROP    (60)
#define TASK11_LINE_LOST_TURN         (150)
#define TASK11_STRAIGHT_LOST_BASE_DROP (240)
#define TASK11_STRAIGHT_LOST_TURN     (80)
#define TASK11_ARC_LOST_BASE_DROP     (TASK3_ARC_LOST_BASE_DROP)
#define TASK11_ARC_LOST_TURN          (TASK3_ARC_LOST_TURN)
#define TASK11_STRAIGHT_ARC_START_COUNT (9300)
#define TASK11_STRAIGHT_POINT_ARM_COUNT (9000)
#define TASK11_STRAIGHT_FORCE_COUNT   (12800)
#define TASK11_STRAIGHT_POINT_ERROR_MIN (1200)
#define TASK11_STRAIGHT_POINT_WIDE_COUNT (3)
#define TASK11_STRAIGHT_POINT_CONFIRM_COUNT (2)
#define TASK11_STRAIGHT_CROSS_IGNORE_COUNT (7600)
#define TASK11_CROSS_ACTIVE_COUNT     (6)
#define TASK11_LEFT_SENSOR_MASK       (0x07U)
#define TASK11_CENTER_SENSOR_MASK     (0x18U)
#define TASK11_RIGHT_SENSOR_MASK      (0xE0U)
#define TASK11_ARC_POINT_ARM_COUNT    (7200)
#define TASK11_ARC_POINT_YAW_ARM_CDEG (15000)
#define TASK11_ARC_FORCE_COUNT        (TASK3_ARC_FORCE_STOP_COUNT)
#define TASK11_ARC_POINT_WIDE_COUNT   (TASK3_ARC_WIDE_LINE_MIN_COUNT)
#define TASK11_ARC_POINT_CONFIRM_COUNT (2)
#define TASK11_ALIGN_TOL_CDEG         (180)
#define TASK11_ALIGN_STABLE_COUNT     (3)
#define TASK11_ALIGN_TIMEOUT_MS       (3000)
#define TASK11_ALIGN_FAST_PWM         (230)
#define TASK11_ALIGN_SLOW_PWM         (150)
#define TASK11_ALIGN_SLOW_ZONE_CDEG   (900)
#define TASK11_ALIGN_GZLP_TOL_MDPS    (8000)
#define TASK11_C_ENTRY_TURN_CDEG      (3200)
#define TASK11_D_ENTRY_TURN_CDEG      (-3200)
