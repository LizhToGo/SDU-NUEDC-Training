...
#define RACE_RAM_LOG_ENABLE       (1)
#define RACE_RAM_LOG_MAX_LAPS     (5)
#define RACE_RAM_WINDOW_CAPACITY  (320)
...
#define RACE_RAM_WINDOW_LOG_STRIDE (5)
#define RACE_DUMP_LINE_DELAY_MS   (80)
#define RACE_DUMP_SECTION_DELAY_MS (100)
#define RACE_DUMP_SUM_ENABLE      (1)
#define RACE_DUMP_EVT_ENABLE      (1)
#define RACE_DUMP_WIN_ENABLE      (1)
#define RACE_DUMP_WIN_STRIDE      (2)
...
#define RACE_TASK4_LINE_MAX_PWM     (999)
...
#define RACE_CB_ARC_ENTRY_TARGET_DIFF  (-64)
#define RACE_CB_ARC_CRUISE_TARGET_DIFF (-60)
#define RACE_DA_ARC_ENTRY_TARGET_DIFF  (64)
#define RACE_DA_ARC_CRUISE_TARGET_DIFF (60)
#define RACE_ARC_YAW_NAV_ENABLE     (0)
#define RACE_ARC_YAW_CORR_DIVISOR   (260)
#define RACE_ARC_YAW_CORR_MAX       (0)
...
#define RACE_TURN_YAW_STOP_TOL_CDEG    (180)
#define RACE_TURN_YAW_SLOW_ZONE_CDEG   (900)
#define RACE_TURN_YAW_STOP_GZLP_TOL_MDPS (14000)
#define RACE_TASK4_EXIT_TURN_PREDICT_ENABLE (0)
#define RACE_TASK4_EXIT_TURN_PREDICT_MS     (10)
...
#define RACE_POINT_ADVANCE_COUNT    (800)
#define RACE_ARC_POINT_ADVANCE_COUNT (900)
...
#define RACE_TASK4_BD_FORCE_TURN_COUNT (7400)
