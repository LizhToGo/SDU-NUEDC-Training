...
#define RACE_AC_HEADING_TARGET_CDEG (150)
#define RACE_BD_HEADING_TARGET_CDEG (-10600)
/* Task4 uses the same old AC/BD target logic, but with its own tunable set. */
#define RACE_TASK4_AC_HEADING_TARGET_CDEG (265)
#define RACE_TASK4_BD_HEADING_TARGET_CDEG (-10700)
...
#define RACE_AC_FORCE_TURN_COUNT    (7600)
#define RACE_TASK4_FIRST_AC_FORCE_TURN_COUNT (8000)
#define RACE_BD_FORCE_TURN_COUNT    (7500)
#define RACE_FORCE_ENTRY_TURN_CDEG  (4500)
