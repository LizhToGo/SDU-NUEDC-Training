    ...
    int32_t gyro_z_filtered_mdps)
{
    ...
    int32_t expected_yaw_cdeg = race_phase_start_expected_yaw_cdeg(phase);
...
#define race_log_segment_start_snapshot(lap, phase, elapsed_ms, nav_ok, yaw_cdeg, gyro_z_filtered_mdps) ((void)0)
